  ...
  return (
    <section className="relative z-20 ">
      ...
      <div className="absolute inset-0 z-10 flex flex-col  ">
        <div className="flex gap-[132px] px-[100px] pb-0 pt-[300px] h-fit max-md:flex-col max-md:gap-6 max-sm:px-4 max-sm:pt-[80px] sm:px-8 sm:gap-8 sm:pt-[120px] md:px-12 md:gap-12 md:pt-[180px] lg:px-16 lg:gap-20 lg:pt-[240px] xl:px-[100px] xl:gap-[132px] xl:pt-[300px] max-sm:bg-[#203236] max-xl:flex-col">
